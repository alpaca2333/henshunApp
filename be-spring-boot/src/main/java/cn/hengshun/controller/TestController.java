...
public class TestController {
    ...
    public @ResponseBody
    String addCustomer(@RequestParam(value="name") String name,
    ...
    public @ResponseBody
    String addRelation(@RequestParam(value="customerName") String customerId,
    ...
    public @ResponseBody
    String addClient(@RequestParam(value="username") String username,
    ...
    public @ResponseBody
    String addClerk(@RequestParam(value="name") String name,
                    @RequestParam(value="phoneNumber") String phoneNumber,
                    @RequestParam(value="password") String password){
    ...
    public @ResponseBody
    String addBabay(@RequestParam(value="name") String name,
                    @RequestParam(value="gender") String gender,
                    @RequestParam(value="birthday") String birthday,
    ...
    public @ResponseBody
    ResultMessage allCustomers(HttpServletRequest request) {
